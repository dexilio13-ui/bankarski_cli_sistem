...
from models.enums import StatusRacuna, TipRacuna, Uloga, Valuta
...
def seed_data() -> None:
    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        if cursor.fetchone()[0] == 0:
            console.print("[bold cyan]🌱 Baza je prazna, dodajem početne podatke po specifikaciji...[/bold cyan]")
            ...
            # 💭 Faza 3: lozinke se čuvaju kao SHA-256 heš, ne kao čist tekst.
            korisnici = [
                (id_marko, "Marko", "Kraljević", "admin", hesiraj_lozinku("admin123"), Uloga.DIREKTOR.value),
                (id_jovan, "Jovan", "Jovanović", "radnik1", hesiraj_lozinku("pass1"), Uloga.RADNIK.value),
                (id_ana, "Ana", "Anić", "radnik2", hesiraj_lozinku("pass2"), Uloga.RADNIK.value),
                (id_pera, "Pera", "Perić", "pera", hesiraj_lozinku("pera123"), Uloga.KLIJENT.value),
                (id_mika, "Mika", "Mikić", "mika", hesiraj_lozinku("mika123"), Uloga.KLIJENT.value),
                (id_zika, "Žika", "Žikić", "zika", hesiraj_lozinku("zika123"), Uloga.KLIJENT.value)
            ]
            ...
            console.print("[bold green]✅ Početni nalozi i računi uspešno uvezeni u SQLite bazu podataka.[/bold green]")
